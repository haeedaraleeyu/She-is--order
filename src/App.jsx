...
size: form.size,
shirt_qty: form.shirtQty,
trouser_qty: form.trouserQty,
total: total,
          ...
          <div key={o.id} style={GS.orderCard} onClick={() => setExpandedOrder(expandedOrder === o.id ? null : o.id)}>
            ...
            {expandedOrder === o.id && (
              <div style={{ marginTop: 12, borderTop: "1px solid #F0EDE8", paddingTop: 12 }}>
                {o.shirt_qty > 0 && <div style={{ fontSize: 12, color: "#888", marginBottom: 2 }}>Shirt × {o.shirt_qty} — {formatNaira(o.shirt_qty * SHIRT_PRICE)}</div>}
                {o.trouser_qty > 0 && <div style={{ fontSize: 12, color: "#888", marginBottom: 2 }}>Trouser × {o.trouser_qty} — {formatNaira(o.trouser_qty * TROUSER_PRICE)}</div>}
